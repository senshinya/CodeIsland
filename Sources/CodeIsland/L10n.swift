...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "shortcut_skipQuestion": "Dismiss Question",
        "shortcut_skipQuestion_desc": "Dismiss current question without replying to the CLI",
        ...
        "expanded_usage_display": "Subscription Usage in Expanded Bar",
        "none": "None",
        "claude": "Claude",
        "codex": "Codex",
        "show_usage_info": "Show Claude Usage in Expanded Bar",
        "show_codex_usage_info": "Show Codex Usage in Expanded Bar",
        ...
        "chat_scroll_to_bottom": "jump to bottom",
    ...
    private static let zh: [String: String] = [
        ...
        "shortcut_skipQuestion": "忽略问题",
        "shortcut_skipQuestion_desc": "忽略当前问答卡片，不向 CLI 回复",
        ...
        "claude": "Claude",
        "codex": "Codex",
        "show_usage_info": "展开栏显示 Claude 用量",
        "show_codex_usage_info": "展开栏显示 Codex 用量",
        "panel_size": "面板尺寸",
